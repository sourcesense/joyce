...
public enum NotificationEvent {
    ...
    SINK_MONGODB_STORED,
    SINK_MONGODB_FAILED,
    SINK_MONGODB_DELETED, MODEL_CONTENT_PROCESSING_FAILED, MODEL_CONTENT_INSERT_FAILED, MODEL_CONTENT_DELETE_FAILED, MODEL_CONTENT_DELETE_SUCCEDED, MODEL_CONTENT_INSERT_SUCCEDED;
