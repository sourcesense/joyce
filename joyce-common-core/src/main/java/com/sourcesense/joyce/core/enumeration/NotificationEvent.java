...
public class NotificationEvent {
	...
	public static final String IMPORT_FAILED_INVALID_MESSAGE_KEY = "IMPORT_FAILED_INVALID_MESSAGE_KEY";
	public static final String IMPORT_FAILED_INVALID_SCHEMA = "IMPORT_FAILED_INVALID_SCHEMA";
