...
public class JoyceContentURI extends JoyceTaxonomyURI{
	...
	public JoyceContentURI(URI uri, String kind, String name, String domain, String product, String contentType) {
	...
	public String getSchemaUri() {
	 		return String.format(
					...
					URI_SCHEMA, URI_SEPARATOR,
					JoyceURIKind.CONTENT, URI_SEPARATOR,
					domain, URI_SEPARATOR,
					product, URI_SEPARATOR,
					name, URI_SEPARATOR,
					JoyceURIContentType.SCHEMA
			);
	}
