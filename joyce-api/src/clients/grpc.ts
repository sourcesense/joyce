...
const JOYCE_API_SCHEMA_GRPC_ENDPOINT = process.env.JOYCE_API_SCHEMA_GRPC_ENDPOINT || "import-gateway:6666";
const logger = logFactory({ name: "grpc-client" });
const client = new SchemaApiClient(JOYCE_API_SCHEMA_GRPC_ENDPOINT, grpc.credentials.createInsecure());
