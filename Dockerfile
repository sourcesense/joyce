...
ENV CONNECT_GROUP_ID=nile-jdbc-connector
ENV CONNECT_CONFIG_STORAGE_TOPIC=nile-kafka-connector-config
ENV CONNECT_OFFSET_STORAGE_TOPIC=nile-kafka-connector-offsets
ENV CONNECT_STATUS_STORAGE_TOPIC=nile-kafka-connector-status
